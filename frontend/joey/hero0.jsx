    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mt-10 flex justify-center space-x-4">
          ...
          <a
            href="#how-it-works"
            className="bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 text-indigo-700 dark:text-indigo-400 px-8 py-3 border border-indigo-700 dark:border-indigo-400 rounded-md text-base font-medium"
          >
            How it works
          </a>
        </div>
