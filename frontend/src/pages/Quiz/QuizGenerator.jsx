...
import { FiUpload, FiFile, FiX, FiZap, FiCheck, FiClock, FiRefreshCw } from 'react-icons/fi';
...
const QuizGenerator = () => {
  ...
  const generateQuiz = async () => {
    ...
    try {
      ...
      if (!apiKey) {
        throw new Error('OpenRouter API key not found. Please set VITE_OPENROUTER_KEY in your .env file or add it to localStorage.');
      }
      ...
      const validatedQuestions = quizJson.questions.slice(0, quizSettings.questionCount).map((q, i) => {
        ...
        return {
          ...
          options: options.map((opt, idx) => opt.replace('Option', `Option ${idx + 1}`)),
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-8">
              <div className="text-center mb-8">
                ...
                <div className="text-6xl font-bold text-teal-600 dark:text-teal-400 mb-2">{score}%</div>
                <p className="text-gray-600 dark:text-gray-300">
                  You got {generatedQuiz.questions.filter(q => userAnswers[q.id] === q.correctAnswer).length} out of {generatedQuiz.questions.length} questions correct
                </p>
              </div>
                ...
                {generatedQuiz.questions.map((question, index) => {
                  ...
                  return (
                    <div key={question.id} className={`p-6 rounded-xl border-2 ${
                      isCorrect ? 'border-green-200 bg-green-50 dark:border-green-700 dark:bg-green-900/20' : 
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-8">
              <div className="mb-8">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">{generatedQuiz.title}</h2>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-8">
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-slate-50 dark:bg-slate-700 rounded-full mb-4 overflow-hidden">
                <img src="/SBmascot.png" alt="StudyBuddy Mascot" className="w-12 h-12 object-contain" />
              </div>
              <h1 className="text-3xl font-bold text-black dark:text-teal-400 mb-2">StudyBuddy Quiz Generator</h1>
              <p className="text-gray-600 dark:text-gray-300">Upload your study materials and get personalized quiz questions</p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6 mb-8">
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">Quiz Settings</h3>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setQuizSettings(prev => ({ ...prev, model: e.target.value }))}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                  >
            ...
            <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-8 text-center mb-6 hover:border-blue-400 dark:hover:border-blue-500 transition">
              ...
              <label htmlFor="file-upload" className="cursor-pointer">
                ...
                <h3 className="text-lg font-medium text-gray-700 dark:text-gray-200 mb-2">Upload Study Materials</h3>
            ...
            {uploadedFiles.length > 0 && (
              <div className="mb-8">
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">Uploaded Files</h3>
                <div className="space-y-3">
